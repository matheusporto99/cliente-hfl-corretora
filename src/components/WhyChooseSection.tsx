...
const WhyChooseSection = () => {
  ...
  return (
    <section id="why-choose" className="py-32 bg-gradient-to-br from-secondary/50 to-muted/30">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-20 fade-in-up">
          ...
          <p className="text-hero max-w-3xl mx-auto">
            Mais de duas décadas protegendo veículos com excelência e confiança
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {pillars.map((pillar, index) => (
            <div
              key={pillar.title}
              className="group relative bg-card p-8 rounded-2xl shadow-[--shadow-card] transition-all duration-500 hover:shadow-[--shadow-hero] hover:-translate-y-2 border border-border/30 fade-in-up"
